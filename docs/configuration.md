...
هذا الملف يشرح كل قيمة يحتاجها الخادم، ومكان تخزينها، وطريقة التحقق منها. تُحفظ القيم الحساسة في **Hugging Face Space Secrets** أو في مدير أسرار مكافئ، ولا تُحفظ في Git.
